 ...
 *
 */
#ifndef __IMAQADAPTOR__IENGINEPROPCONTAINER__HEADER__
#define __IMAQADAPTOR__IENGINEPROPCONTAINER__HEADER__
...
namespace imaqkit
{
    ...
    class IEnginePropCustomGetFcn;

    /**
     * Class IEnginePropContainer
     *
     ...
     *
     */
    class IEnginePropContainer : public imaqkit::IMAQInterface
    {
      ...
      public:
         ...
         *
         */
        virtual void setPropValue(const char* propertyName, void* newValue, bool doInternalCheck = true) = 0;
         ...
         */
        virtual bool checkPropValue(const char* propertyName, void* value) = 0;
         ...
         */
        virtual void* getPropValue(const char* propertyName) = 0;
         ...
         */
        virtual int getPropValueAsInt(const char* propertyName) = 0;
         ...
         */
        virtual double getPropValueAsDouble(const char* propertyName) = 0;
         ...
         */
        virtual bool isPropertyAvailable(const char* propertyName) = 0;
         ...
         * @param propertyName: Name of the property.
         *
         * @return imaqkit::IEnginePropInfo*: Property information interface, or NULL.
         */
        virtual imaqkit::IEnginePropInfo* getIPropInfo(const char* propertyName) = 0;
         ...
         *
         */
        virtual void getPropNames(const char** list) = 0;
         ...
         */
        virtual const char* getEnumString(const char* propertyName) = 0;
         ...
         *
         * @param propertyName: Name of the enumerated property.
         * @param enumStrID: Identifier for one of the enumerated property's string values.
         *
         * @return const char*: The enumerated string value, or NULL.
         */
        virtual const char* getEnumString(const char* propertyName, void* enumStrID) = 0;
         ...
         */
        virtual bool setCustomGetFcn(const char* propertyName, imaqkit::IEnginePropCustomGetFcn* getFcn) = 0;
         ...
         * If a property exists with the specified name, the listener is added
         * and true is returned. Upon destruction of the end user's VIDEOINPUT
         * object, the listener is detroyed automatically.
         *
         ...
         */
        virtual bool addListener(const char* propertyName, imaqkit::IEnginePropPostSetListener* setNotifier) = 0;
