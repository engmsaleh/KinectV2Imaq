/**
 * @file:       IEnginePropCustomGetFcn.h
 *
 ...
 *
 */
#ifndef __IMAQADAPTOR__IENGINEPROPCUSTOMGETFCN__HEADER__
#define __IMAQADAPTOR__IENGINEPROPCUSTOMGETFCN__HEADER__
...
namespace imaqkit
{
     ...
     *
     */
    class IEnginePropCustomGetFcn : public IMAQInterface
    {
      ...
      public:
         ...
         */
        virtual ~IEnginePropCustomGetFcn(void) {};
         ...
         */
        virtual void getValue(imaqkit::IEnginePropInfo* propertyInfo, void* value) = 0;
    };
}
